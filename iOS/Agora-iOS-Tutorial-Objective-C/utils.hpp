...
inline std::string HmacSign2(const std::string& appCertificate,
    ...
    CCHmac(kCCHmacAlgSHA256, (const unsigned char*)appCertificate.data(), appCertificate.length(), (const unsigned char*)message.data(), message.length(), md);
