...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    static int expirationTimeInSeconds = 3600 * 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        channel = intent.getStringExtra(getString(R.string.channel));
        encryptionPassword = intent.getStringExtra(getString(R.string.password));
        encryptionMode = intent.getStringExtra(getString(R.string.mode));
    ...
    private void initializeEngine() {
        try {
            int areaCode = RtcEngineConfig.IPAreaCode.AREA_GLOBAL & (~RtcEngineConfig.IPAreaCode.AREA_CN);
            ...
            mRtcEngine.setEncryptionSecret(encryptionPassword);
        } catch (Exception e) {
    ...
    private void joinChannel() {
        ...
        String token = builder.buildTokenWithUid(getString(R.string.agora_app_id), getString(R.string.agora_app_certificate),
                channel, uid, RtcTokenBuilder.Role.Role_Publisher, timestamp);
        mRtcEngine.joinChannel(token, channel, "Extra Optional Data", uid);
    }
