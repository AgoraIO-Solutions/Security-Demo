...
import {RtcTokenBuilder, Role} from './RtcTokenBuilder'
    ...
    return new Promise((resolve) => {    
      ...
      **/
      ...
      this._client.init(this.APPID, () => {
        ...
        this._client.setEncryptionMode(data.encrymode)
        this._client.setEncryptionSecret(data.encryption)
        /**
        ...
        **/
        ...
        const tokenA = RtcTokenBuilder.buildTokenWithUid(this.APPID, this.CERTIFICATE, data.channel, uid, Role.PUBLISHER, privilegeExpiredTs);

        console.log("Token: "+tokenA+", With Integer Number Uid: " + uid);
        this._client.join(tokenA, data.channel, uid, (uid) => {
